...
iperf_udp_accept(struct iperf_test *test)
{
    ...
    FD_SET(test->prot_listener, &test->mster_test->read_set);
    test->mster_test->max_fd = (test->mster_test->max_fd < test->prot_listener) ? test->prot_listener : test->mster_test->max_fd;
